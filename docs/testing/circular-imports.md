...
- **Fail — cycles found:** When madge finds one or more circular imports, the script exits 1. The cycle list goes to stdout (from madge). A summary line `circular-imports: cycles found — fix the imports listed above.` goes to stderr.
