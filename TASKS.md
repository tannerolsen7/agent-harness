...
Phase 3 (Quality Systems) tasks are ready to queue. Phase 4 tasks are noted with size/design requirements.
...
- [ ] UI token lint and design-system enforcement
  Size: MEDIUM
  Slug: ui-token-lint
...
- [ ] Performance budget with measured warnings
  Size: MEDIUM
  Slug: perf-budget
